...
import time
import os
from dataloader.image_resampler_pins import mp_weighted_resampler, ImageLoader3, stratified_train_val_split, \
...
def main(args):
    ...
    if region == 'singlepinpad':
        ...
        aug_train_pair_data_filenames = [
                                        ...
                                        # 这两个不可以加入训练，因为对应的测试集加入了bbtest黑盒测试，且这里面的ng是test on train;
                                        # val_image_pair_path_gaoce2 = os.path.join(image_folder, 'merged_annotation', date,
                                                                            # f'aug_train_pair_labels_padgroup_250121_final_rgb_DA679_dropoldpairs.csv')  
                                        #  val_image_pair_path_gaoce4 = os.path.join(image_folder, 'merged_annotation', date,
                                                                            # f'aug_train_pair_labels_padgroup_250121_final_white_DA679_dropoldpairs.csv')      
                                         ]
        ...
        if 'masked' in version_name:
            aug_train_pair_data_filenames += [os.path.join(annotation_folder,
                                            ...
                                            os.path.join(annotation_folder,
                                                        f'aug_train_pair_labels_padgroup_250118_final_rgb_mask_DA663-670_dropoldpairs.csv'), 
                                              ]
        ...
        if 'rgbwhite' in version_name:
            aug_train_pair_data_filenames += [
                                            ...
                                            os.path.join(annotation_folder,
                                                           f'aug_train_pair_labels_padgroup_250118_final_white_DA663-670_dropoldpairs.csv'),  
            ...
            if 'masked' in version_name:
                aug_train_pair_data_filenames += [os.path.join(annotation_folder,
                                                ...
                                                os.path.join(annotation_folder,
                                                              f'aug_train_pair_labels_padgroup_250118_final_white_mask_DA663-670_dropoldpairs.csv'),
