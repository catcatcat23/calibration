...
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_single.py --arch=fcdropoutmobilenetv3large --output_type=dual2 --if_cp_val=0 --specila_issue_list=DA730,DA730-cross_pair,DA712_250214 --compression_p=0.5 --select_p=0 --region=singlepad -lr=0.025 --version_name=v0.11.2f1certainlut05cp05crosspairDA730TG --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=64 --resize_h=64 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepad/v0.11TG/singlepadv0.11.2lut05cp05crosspairDA730TG" --data="/dev/shm/classification/data_clean" --date="2501" --worker=18 --batch_size=256 -vr=0.1 --score='f1' --label_conf='certain' --reload_mode='skip_mismatch' -kdr=0.0 --resume="${WORKDIR}/models/checkpoints/singlepad/v0.11TG/singlepadv0.11tp1select/singlepadfcdropoutmobilenetv3largers6464s42c3val0.1b256_ckp_bestv0.11.0f1certaincp05crosspairDA730TG20.0j0.4lr0.025nb256nm256dual2top1.pth.tar" --lut_p=0.5 &
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_single.py --arch=fcdropoutmobilenetv3large --output_type=dual2 --if_cp_val=0 --specila_issue_list=DA730,DA730-cross_pair,DA712_250214 --compression_p=0.5 --select_p=0 --region=singlepad -lr=0.1 --version_name=v0.11.2f1certainretrainlut05cp05crosspairDA730TG --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=64 --resize_h=64 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepad/v0.11TG/singlepadv0.11.2retrainlut05cp05crosspairDA730TG" --data="/dev/shm/classification/data_clean" --date="2501" --worker=18 --batch_size=256 -vr=0.1 --score='f1' --label_conf='certain' --reload_mode='skip_mismatch' -kdr=0.0 --seed=8 --lut_p=0.5 &
