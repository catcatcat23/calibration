...
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random_ori.py --arch=fcdropoutmobilenetv3large  --output_type=dual2 --if_cp_val=0  --select_p=0.5 --compression_p=0.5 --region=singlepad -lr=0.025 --version_name=v0.13.0f1certaincp05 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=64 --resize_h=64 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepad/v0.13/singlepadv0.13.0cp05" --data="/dev/shm/classification/data_clean" --date="2501" --worker=18 --batch_size=256 -vr=0.1 --score='f1' --label_conf='certain' --reload_mode='skip_mismatch' -kdr=0.0 --resume="${WORKDIR}/models/checkpoints/singlepad/v0.12final/singlepadv0.12finalselect/singlepadfcdropoutmobilenetv3largers6464s42c3val0.1b256_ckp_bestv0.12.4f1certaincp0520.0j0.4lr0.025nb256nm256dual2last.pth.tar" --lut_p=0 &
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random_ori.py --arch=fcdropoutmobilenetv3large  --output_type=dual2 --if_cp_val=0  --select_p=0.5 --compression_p=0.5 --region=singlepad -lr=0.1 --version_name=v0.13.0f1certainretraincp05 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=64 --resize_h=64 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepad/v0.13/singlepadv0.13.0retraincp05" --data="/dev/shm/classification/data_clean" --date="2501" --worker=18 --batch_size=256 -vr=0.1 --score='f1' --label_conf='certain' --reload_mode='skip_mismatch' -kdr=0.0 --seed=8 --lut_p=0 &
