...
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_single.py --arch=mobilenetv3small --region=singlepinpad --specila_issue_list=DA730_add_DA745_aug_ng --if_cp_val=0 --select_p=0 --compression_p=0.5 --output_type=dual2 -lr=0.025 --version_name=v2.11.2f1certainNGonlycp05 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.11/singlepinpadv2.11.2NGonlycp05" --data="/dev/shm/classification/data_clean" --date="2501" --reload_mode='skip_mismatch' --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --resume="${WORKDIR}/models/checkpoints/singlepinpad/v2.11tp2/singlepinpadv2.11tp2select/singlepinpadmobilenetv3smallrs12832s42c3val0.15b256_ckp_bestv2.11.2f1certaincp0520.0j0.4lr0.025nb256nm256dual2top0.pth.tar" --lut_p=0.0 &
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_single.py --arch=mobilenetv3small --region=singlepinpad --specila_issue_list=DA730_add_DA745_aug_ng --if_cp_val=0 --select_p=0 --compression_p=0.5 --output_type=dual2 -lr=0.1 --version_name=v2.11.2f1certainNGonlyretraincp05 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.11/singlepinpadv2.11.2NGonlyretraincp05" --data="/dev/shm/classification/data_clean" --date="2501" --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --lut_p=0.0 &