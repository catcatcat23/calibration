...
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random.py --arch=mobilenetv3small --output_type=dual2 --if_save_test_best_model=True --specila_issue_list=yl_lh,bp_stove_clean,jxlzy_ori  --if_cp_val=0 --select_p=0.5 --compression_p=0.5 --region=singlepinpad -lr=0.025 --version_name=v2.15.9f1certaincp05cleanori --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.15_jxlzy/singlepinpadv2.15.9cp05cleanori" --data="/dev/shm/classification/data_clean" --date="2501" --reload_mode='skip_mismatch' --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --resume="${WORKDIR}/models/checkpoints/singlepinpad/v2.15tp1/singlepinpadv2.15tp1select/singlepinpadmobilenetv3smallrs12832s42c3val0.15b256_ckp_bestv2.15.0f1certaincp0520.0j0.4lr0.025nb256nm256dual2bestbiacc.pth.tar" --lut_p=0.0 &
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random.py --arch=mobilenetv3small --output_type=dual2 --if_save_test_best_model=True --specila_issue_list=yl_lh,bp_stove_clean,jxlzy_ori  --if_cp_val=0 --select_p=0.5 --compression_p=0.5 --region=singlepinpad -lr=0.1 --version_name=v2.15.9f1certainretraincp05cleanori --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.15_jxlzy/singlepinpadv2.15.9retraincp05cleanori" --data="/dev/shm/classification/data_clean" --date="2501" --reload_mode='skip_mismatch' --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --lut_p=0 &
