...
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random.py --arch=mobilenetv3small --region=singlepinpad --if_save_test_best_model=True --specila_issue_list=bp_stove_clean,hrd_led_switch_op,DA730FAE_add_DA745,hrd_switch_fp --if_cp_val=0 --select_p=0.5 --compression_p=0.5 --output_type=dual2 -lr=0.025 --version_name=v2.15.11f1certainNGonlycp05cleanf11 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.15_yl_hrd_led_switch/singlepinpadv2.15.11NGonlycp05cleanf11" --data="/dev/shm/classification/data_clean" --date="2501" --reload_mode='skip_mismatch' --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --resume="${WORKDIR}/models/checkpoints/singlepinpad/v2.11.8/singlepinpadmobilenetv3smallrs12832s42c3val0.15b256_ckp_bestv2.11.8f1certainNGonlycp0520.0j0.4lr0.025nb256nm256dual2top1.pth.tar" --lut_p=0.0 &
python3 ${WORKDIR}/main_advanced_kd_cl_tb_cp_random.py --arch=mobilenetv3small --region=singlepinpad --if_save_test_best_model=True --specila_issue_list=bp_stove_clean,hrd_led_switch_op,DA730FAE_add_DA745,hrd_switch_fp --if_cp_val=0 --select_p=0.5 --compression_p=0.5 --output_type=dual2 -lr=0.1 --version_name=v2.15.11f1certainNGonlyretraincp05cleanf11 --epochs=600 --gpu=0 -nb=256 -nm=256 -ji=0.4 --resize_w=128 --resize_h=32 --optimizer_type=sgd --ckp="${WORKDIR}/models/checkpoints/singlepinpad/v2.15_yl_hrd_led_switch/singlepinpadv2.15.11NGonlyretraincp05cleanf11" --data="/dev/shm/classification/data_clean" --date="2501" --worker=8 --batch_size=256 -vr=0.15 --score='f1' --label_conf='certain' -kdr=0.0 --lut_p=0.0 &
