...
#                                                          f'aug_train_pair_labels_{region}_240913_final_white.csv'),
            ...
            aug_val_pair_data_filenames = [os.path.join(img_folder, 'merged_annotation', date, f'aug_val_pair_labels_{region}_mergedresorted_model_cleaned_250123.csv'),
                                            os.path.join(img_folder, 'merged_annotation', date, f'aug_val_pair_labels_{region}_240328b_finalresorted_model_cleaned_250123.csv'),
                                            os.path.join(img_folder, 'merged_annotation', date, f'aug_test_pair_labels_{region}_240328b_finalresorted_model_cleaned_250123.csv'),
                                           os.path.join(img_folder, 'merged_annotation', date,
    ...
    if val_ratio == 0:
        ...
        if aug_val_pair_data_filenames is not None:
            ...
            for i, datum in aug_val_pair_data_df.iterrows():
                ...
                material_val.append(str(datum['material_id']))
