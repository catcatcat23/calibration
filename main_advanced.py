...
#                                                          f'aug_train_pair_labels_{region}_240913_final_white.csv'),
                                            ...
                                            # os.path.join(img_folder, 'merged_annotation', date,
                                            # f'aug_train_pair_labels_body_241103_final_white.csv'),                                            
                                            ...
                                            os.path.join(img_folder, 'merged_annotation', date,
                                            f'body_white_paris_final_train_refine.csv'),
                                             os.path.join(img_folder, 'merged_annotation', date,
                                            f'body_rgb_paris_final_train_refine.csv'),
...
#             os.path.join(img_folder, 'merged_annotation', date, f'aug_test_pair_labels_{region}_240819_final_white.csv')
                                            ...
                                            os.path.join(img_folder, 'merged_annotation', date,
                                            f'body_white_paris_final_test_refine.csv'),
                                             os.path.join(img_folder, 'merged_annotation', date,
                                            f'body_rgb_paris_final_test_refine.csv'),
