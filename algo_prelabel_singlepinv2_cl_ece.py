...
parser.add_argument('--version_folder', default='singlepadv0.12finalselect', type=str) #singlepadv0.6impl   singlepadv0.9 padgroupv1.10rgbwhite
...
parser.add_argument('--if_calcu_ECE', default=True, type=bool)
